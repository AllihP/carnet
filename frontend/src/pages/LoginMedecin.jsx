...
const COLOR = '#0E7A5F'
const FEATURES = ['Dossiers médicaux complets', 'Consultations & prescriptions', 'Suivi des rendez-vous']
...
export default function LoginMedecin() {
  ...
  const handleSubmit = async e => {
    ...
    setLoading(true)
    try {
      const res = await api.post('/medecin/login/', form)
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden login-bg-medecin">
      ...
      <div className="relative z-10 flex gap-16 items-center max-w-4xl w-full px-8 py-10">
        ...
        <div className="flex-1 hidden md:block">
          ...
          <h1 className="font-display text-4xl text-white leading-tight mb-4">
            Espace<br />Médecin<br />
            <span style={{ color: COLOR }}>Sécurisé</span>
          </h1>
          <p className="text-sm text-white/40 leading-relaxed max-w-xs mb-8">
            Accédez à vos dossiers patients, gérez vos consultations et prescriptions.
          </p>
        ...
        <div className="w-[400px] flex-shrink-0">
          <div className="glass-box p-9">
            <div className="flex items-center gap-2.5 mb-1">
              ...
              <div className="font-display text-2xl text-white">Espace Médecin</div>
            </div>
            <div className="text-xs text-white/40 mb-7">Connexion réservée aux praticiens</div>
            ...
            <div className="mt-5 p-3 rounded-lg text-[11px] text-white/30 leading-relaxed" style={{ background: 'rgba(255,255,255,.04)' }}>
              Créez un compte via Django admin ou <code className="text-white/50">createsuperuser</code>
            </div>
          </div>
        </div>
